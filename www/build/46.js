...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewDiscussionCreatePageModule", function() { return NewDiscussionCreatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__new_discussion_create__ = __webpack_require__(910);
...
var NewDiscussionCreatePageModule = /** @class */ (function () {
    function NewDiscussionCreatePageModule() {
    }
    NewDiscussionCreatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__new_discussion_create__["a" /* NewDiscussionCreatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__new_discussion_create__["a" /* NewDiscussionCreatePage */]),
            ],
        })
    ], NewDiscussionCreatePageModule);
    return NewDiscussionCreatePageModule;
}());

//# sourceMappingURL=new-discussion-create.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NewDiscussionCreatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
...
/**
 * Generated class for the NewDiscussionCreatePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var NewDiscussionCreatePage = /** @class */ (function () {
    function NewDiscussionCreatePage(navCtrl, navParams, storage, global, http, loadingCtrl, speechRecognition, toastCtrl, gFn, plt, keyboard, global_api) {
        var _this = this;
    ...
    NewDiscussionCreatePage.prototype.checkFilterIsActive = function () {
        setTimeout(function () {
            if (__WEBPACK_IMPORTED_MODULE_5_jquery__('page-new-discussion-create .filter_overlay .active').length) {
    ...
    NewDiscussionCreatePage.prototype.getDefaultData = function (afterSearch) {
        var _this = this;
        this.storage.get('loggedInUserData').then(function (val) {
            ...
            var searchVal = __WEBPACK_IMPORTED_MODULE_5_jquery__("page-new-discussion-create #search").val();
    ...
    NewDiscussionCreatePage.prototype.goBack = function () {
        this.navCtrl.pop();
        this.navCtrl.pop();
        this.navCtrl.push('NewDiscussionListPage');
    };
    NewDiscussionCreatePage.prototype.viewChat = function (group_id, chat_person_name, photoPath, char_Person_id) {
        var chatInfo = {
            from: 1,
            to: 10,
    ...
    NewDiscussionCreatePage.prototype.viewGroupChat = function (group_id, team_id, group_type, photo, name) {
        var chatInfo = {
            from: 1,
            to: 10,
            person_id: this.personId,
    ...
    NewDiscussionCreatePage.prototype.search = function (event) {
        var _this = this;
        if (event.key === "Enter") {
            return false;
        }
    ...
    NewDiscussionCreatePage.prototype.clearsearch = function () {
        if (__WEBPACK_IMPORTED_MODULE_5_jquery__("page-new-discussion-create #search").val() == "Search") {
            __WEBPACK_IMPORTED_MODULE_5_jquery__("page-new-discussion-create #search").val('');
        }
    };
    NewDiscussionCreatePage.prototype.toggleOverview = function () {
    ...
    NewDiscussionCreatePage.prototype.listen = function () {
        var _this = this;
                ...
                _this.speechRecognition.hasPermission()
                    ...
                    if (hasPermission) {
                        _this.speechRecognition.startListening()
                            ...
                            __WEBPACK_IMPORTED_MODULE_5_jquery__("page-new-discussion-create #search").blur();
                            __WEBPACK_IMPORTED_MODULE_5_jquery__("page-new-discussion-create #search").val(matches[0]).focus();
    ...
    NewDiscussionCreatePage.prototype.addGroupName = function (chatDetails, ev) {
        this.chatDetailsChangeLower = Object.keys(chatDetails).reduce(function (c, k) { return (c[k.toLowerCase()] = chatDetails[k], c); }, {});
        var sendDiscussionDetails = [];
        sendDiscussionDetails['id'] = this.chatDetailsChangeLower.group_id;
        sendDiscussionDetails['discussionName'] = this.chatDetailsChangeLower.group_name;
        sendDiscussionDetails['image'] = '';
        sendDiscussionDetails['imageFrom'] = 'group';
        //let gruopsIds: any = [];
        this.gruopsIds.push(chatDetails.group_id);
        if (__WEBPACK_IMPORTED_MODULE_5_jquery__(ev.target).hasClass('select-card') == false) {
            __WEBPACK_IMPORTED_MODULE_5_jquery__(ev.target).parents(".select-card").addClass("divDisable");
            __WEBPACK_IMPORTED_MODULE_5_jquery__(ev.target).parents(".select-card").find(".card-img span").addClass("active");
        }
        else {
            __WEBPACK_IMPORTED_MODULE_5_jquery__(ev.target).addClass("divDisable");
            __WEBPACK_IMPORTED_MODULE_5_jquery__(ev.target).find(".card-img span").addClass("active");
        }
        this.newDiscussionDetails.push(sendDiscussionDetails);
    };
    NewDiscussionCreatePage.prototype.addPersonName = function (chatDetails, ev) {
        var sendDiscussionDetails = [];
        sendDiscussionDetails['id'] = chatDetails.char_Person_id;
        sendDiscussionDetails['discussionName'] = chatDetails.chat_person_name;
        sendDiscussionDetails['image'] = chatDetails.photoPath;
        //let personIds: any = [];
        this.personIds.push(chatDetails.char_Person_id);
        if (__WEBPACK_IMPORTED_MODULE_5_jquery__(ev.target).hasClass('select-card') == false) {
            __WEBPACK_IMPORTED_MODULE_5_jquery__(ev.target).parents(".select-card").addClass("divDisable");
            __WEBPACK_IMPORTED_MODULE_5_jquery__(ev.target).parents(".select-card").find(".card-img span").addClass("active");
        }
    ...
    NewDiscussionCreatePage.prototype.deletedPersonName = function (personId, gruopsIds, personIds, ev) {
        this.newDiscussionDetails = this.newDiscussionDetails.filter(function (i) { return i.id !== personId; });
        __WEBPACK_IMPORTED_MODULE_5_jquery__('.select-card[id=' + personId + ']').removeClass("divDisable");
        __WEBPACK_IMPORTED_MODULE_5_jquery__('.select-card[id=' + personId + ']').find(".card-img span").removeClass("active");
    ...
    NewDiscussionCreatePage.prototype.goToDiscussionSavePage = function (selectData, gruopsIds, personIds) {
        if (selectData.length > 0) {
            this.navCtrl.push('NewDiscussionSavePage', { newDiscussionDetails: selectData, gruopsIds: gruopsIds, personIds: personIds });
        }
        else {
            this.gFn.presentToast('Please select a person or group.');
        }
    };
    NewDiscussionCreatePage.prototype.ionViewDidLoad = function () {
        //console.log('ionViewDidLoad NewDiscussionCreatePage');
    };
    NewDiscussionCreatePage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    NewDiscussionCreatePage.prototype.onSwipe = function (event) {
        if (event.offsetDirection == 4) {
            this.closeFilter();
        }
    };
    NewDiscussionCreatePage.prototype.keyboardCheck = function () {
        if (this.mBottom == "") {
    ...
    NewDiscussionCreatePage.prototype.inputFocus = function () {
        this.keyboardCheck();
    };
    NewDiscussionCreatePage.prototype.inputBlur = function () {
        this.keyboardCheck();
    };
    NewDiscussionCreatePage.prototype.filterData = function () {
        this.filtering = true;
        this.sportIds = [];
        var sportIds = [];
        __WEBPACK_IMPORTED_MODULE_5_jquery__('page-new-discussion-create .sports.active').each(function () {
        ...
        this.divisionIds = [];
        var divisionIds = [];
        __WEBPACK_IMPORTED_MODULE_5_jquery__('page-new-discussion-create .division.active').each(function () {
            if (__WEBPACK_IMPORTED_MODULE_5_jquery__(this).prop('id') != 0) {
        ...
        this.selectedTeams = [];
        var selectedTeams = [];
        __WEBPACK_IMPORTED_MODULE_5_jquery__('page-new-discussion-create .team.active').each(function () {
            if (__WEBPACK_IMPORTED_MODULE_5_jquery__(this).prop('id') != 0) {
        ...
        this.roles = [];
        var roles = [];
        __WEBPACK_IMPORTED_MODULE_5_jquery__('page-new-discussion-create .role.active').each(function () {
            if (__WEBPACK_IMPORTED_MODULE_5_jquery__(this).prop('id') != 0) {
    ...
    NewDiscussionCreatePage.prototype.getFilterDetails = function () {
        var _this = this;
    ...
    NewDiscussionCreatePage.prototype.showFilter = function () {
    ...
    NewDiscussionCreatePage.prototype.closeFilter = function () {
    ...
    NewDiscussionCreatePage.prototype.filterBack = function () {
        __WEBPACK_IMPORTED_MODULE_5_jquery__('.filterBack, .sportFilter, .divisionFilter, .teamFilter, .roleFilter').hide();
        __WEBPACK_IMPORTED_MODULE_5_jquery__('.fliter .sub-title').html('Filter');
        __WEBPACK_IMPORTED_MODULE_5_jquery__('.options').show();
    };
    NewDiscussionCreatePage.prototype.filterHandler = function () {
        var _this = this;
        if (this.isFirstFilter) {
            ...
            __WEBPACK_IMPORTED_MODULE_5_jquery__('.division').click(function (e) {
                ...
                /* this.divisionIds = [];
                let divisionIds = [];
                $('page-new-discussion-create .division.active').each(function() {
                  if($(this).prop('id') != 0){
            ...
            __WEBPACK_IMPORTED_MODULE_5_jquery__('.sports').click(function (e) {
                ...
                /* this.sportIds = [];
                let sportIds = [];
                $('page-new-discussion-create .sports.active').each(function() {
                  if($(this).prop('id') != 0){
    ...
    return NewDiscussionCreatePage;
}());

//# sourceMappingURL=new-discussion-create.js.map
